    ...
    <div className='mb-10'>
        <div className='relative mt-20 w-full'>
            ...
            <div className='grid grid-cols-6 gap-10 w-3/4 mx-auto mt-10'>
                <div className=' h-48  bg-zinc-900 hover:shadow-lg hover:shadow-red-600 duration-500 hover:scale-105 rounded-lg p-5 one4 opacity-0'>
                    ...
                    <h2 className=' text-slate-200 text-sm mt-5 mx-auto w-fit text-center'>Continuos Integration and Deployment</h2>
                </div>
                <div className=' h-48  bg-zinc-900 hover:shadow-lg hover:shadow-red-600 duration-500 hover:scale-105 rounded-lg p-5 two4 opacity-0'>
                    <FaGit className='text-red-600  font-bold text-4xl w-fit mx-auto '></FaGit>
                ...
                <div className=' h-48  bg-zinc-900 hover:shadow-lg hover:shadow-red-600 duration-500 hover:scale-105 rounded-lg p-5 three4 opacity-0'>
                    <FaGithub className='text-red-600 font-bold text-4xl w-fit mx-auto '></FaGithub>
