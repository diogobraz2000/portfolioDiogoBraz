    ...
    <div>
        <div className='relative mt-20 w-full'>
            ...
            <div className='grid grid-cols-6 gap-10 w-3/4 mx-auto mt-10'>
                <div className=' h-48  bg-zinc-900 hover:shadow-lg hover:shadow-red-600 duration-500 hover:scale-105 rounded-lg p-5 one2 opacity-0'>
                    <SiMysql className='text-red-600 font-bold text-4xl w-fit mx-auto '></SiMysql>
                ...
                <div className=' h-48  bg-zinc-900 hover:shadow-lg hover:shadow-red-600 duration-500 hover:scale-105 rounded-lg p-5 two2 opacity-0'>
                    <SiPostgresql className='text-red-600  font-bold text-4xl w-fit mx-auto '></SiPostgresql>
