            ...
            <div className='flex gap-4'>
                ...
                <div className='mx-auto h-fit p-2'>
                    ...
                    <div className='flex gap-2 max-md:flex-col max-md:justify-center'>
                        <Link href="https://github.com/diogobraz2000" target="_blank" className='w-fit px-4 flex gap-2 max-md:mx-auto bg-purple-500 rounded-lg mt-4 hover:scale-105 hover:shadow-md duration-500 hover:shadow-zinc-700'>
                            <FaGithub className='text-white text-2xl my-auto '></FaGithub>
                            <h1 className='text-xl text-white'>GitHub</h1>
                        </Link>
                        <Link href="https://www.linkedin.com/in/diogo-miguel-braz-8339271a0/"  target="_blank" className='w-fit px-4 max-md:mx-auto flex gap-2 bg-blue-500 rounded-lg mt-4 hover:scale-105 hover:shadow-md duration-500 hover:shadow-zinc-700'>
