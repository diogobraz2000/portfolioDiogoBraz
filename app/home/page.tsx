    ...
    <div className='h-screen w-screen'>
        ...
        <div className=' absolute top-1/2 w-full'>
            <div className='mt-10 w-full'>
                ...
                <Carousel className=' gap-5 w-full   p-5'>
                    <CarouselContent className='p-4'>
                        <CarouselItem className='basis-1/6'>
                            <div className=' relative w-56 h-56 bg-black hover:shadow-red-500 hover:shadow-lg duration-500 rounded-lg hover:scale-105' onClick={ ()=>{window.location.href='/skills';}}>
                        ...
                        <CarouselItem className='basis-1/6'>
                            <div className='relative w-56 h-56 bg-black hover:shadow-red-500 hover:shadow-lg duration-500 rounded-lg hover:scale-105' onClick={ ()=>{window.location.href='/education';}}>
                        ...
                        <CarouselItem className='basis-1/6'>
                            <div className='relative w-56 h-56 bg-black hover:shadow-red-500 hover:shadow-lg duration-500 rounded-lg hover:scale-105' onClick={ ()=>{window.location.href='/education#certifications';}}>
